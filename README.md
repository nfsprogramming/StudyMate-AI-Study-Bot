...
- **Frontend:** React (Vite)
- **AI API:** NVIDIA NIM (Llama 3.2 Vision & Llama 3.1 Instruct)
...
### 2. Backend Setup
1. Set up your environment variables: Create a `.env` file in the `backend/` folder and add:
   ```env
   NVIDIA_API_KEY=your_nvidia_api_key_here
   NVIDIA_VISION_API_KEY=your_nvidia_vision_api_key_here
   ```
2. Place your `credentials.json` in the `backend/` folder for Google Classroom features.
