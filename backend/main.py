...
def clean_ai_response(text: str) -> str:
    """Clean AI response from Pollinations.AI advertisements and extra markers"""
    # Remove common Pollinations.AI ad markers
    ad_markers = [
    ...
    # Also clean up trailing separators like "---"
...
async def call_ai(prompt: str, language: str = "English") -> str:
    ...
    try:
        ...
        if response.status_code == 200:
            return clean_ai_response(response.text.strip())
...
async def ask_question(request: QuestionRequest):
    ...
    try:
        ...
        prompt = f"""Based on the following context from uploaded documents, answer the question accurately and informatively.
...
- Ensure there is **generous spacing** between paragraphs and sections.
- If the question asks for multiple points, list them clearly.

Provide a well-structured, easy-to-read answer based ONLY on the context provided."""
